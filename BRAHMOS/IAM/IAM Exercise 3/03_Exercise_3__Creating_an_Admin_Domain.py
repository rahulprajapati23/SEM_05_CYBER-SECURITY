"""
Interactive Guide for: Exercise 3 – Creating an Admin Domain
"""
import time
import os
import re
...
def main():
    print("=== STARTING EXERCISE: Exercise 3 – Creating an Admin Domain ===")
    web_bot = WebBot()
    print("\n--- INSTRUCTIONS ---")
    print_step("1. Return to the")
    web_bot.try_action("1. Return to the")
    print_step("2. Click the arrow to the right of")
    web_bot.try_action("2. Click the arrow to the right of")
    print_step("3. Complete the Admin Domain form with the following information:")
    web_bot.try_action("3. Complete the Admin Domain form with the following information:")
    print_step("4. Click OK. Your organization tree should have the following hierarchical structure:")
    web_bot.try_action("4. Click OK. Your organization tree should have the following hierarchical structure:")
    print("\n--- DATA ENTRY REQUIRED ---")
    val = get_input("organization. To do this, you create an", "Admin Domain")
    val = get_input("Admin domain name", "TechSupport Business Security")
    val = get_input("Description", "Allows TechSupport to manage their Linux services")
    val = get_input("Administrator", "John Davis")
