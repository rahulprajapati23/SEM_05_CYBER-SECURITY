"""
Interactive Guide for: Exercise 9 – De-provisioning an account
"""
import time
import os
import re
...
def main():
    print("=== STARTING EXERCISE: Exercise 9 – De-provisioning an account ===")
    web_bot = WebBot()
    print("\n--- INSTRUCTIONS ---")
    print_step("1. On the")
    ...
    print_step("4. Click the small")
    web_bot.try_action("4. Click the small")
    print("\n--- DATA ENTRY REQUIRED ---")
    val = get_input("Explain why the operation was", "successful or not successful.")
