"""
Interactive Guide for: Exercise 3 – Verifying account provisioning
"""
import time
import os
import re
...
def main():
    print("=== STARTING EXERCISE: Exercise 3 – Verifying account provisioning ===")
    web_bot = WebBot()
    print("\n--- INSTRUCTIONS ---")
    print_step("1. On the")
    ...
    print_step("3. Click the link under the column")
    web_bot.try_action("3. Click the link under the column")
    print_step("4. In a terminal window, view")
    run_command("4. In a terminal window, view")
    print("\n--- DATA ENTRY REQUIRED ---")
    val = get_input("Clicking the plus sign (+) and you can see", "4  new")
    val = get_input("of  /bin/bash", ":")
