"""
Interactive Guide for: Exercise 4 – Creating child role assignments
"""
import time
import os
import re
...
def main():
    print("=== STARTING EXERCISE: Exercise 4 – Creating child role assignments ===")
    web_bot = WebBot()
    print("\n--- INSTRUCTIONS ---")
    print_step("1. On the")
    web_bot.try_action("1. On the")
    print_step("2. In the")
    web_bot.try_action("2. In the")
    print_step("3. Click")
    web_bot.try_action("3. Click")
    print_step("4. Click the")
    web_bot.try_action("4. Click the")
    print_step("5. Search")
    web_bot.try_action("5. Search")
    print_step("6. Select the three finance child roles:")
    web_bot.try_action("6. Select the three finance child roles:")
    print_step("7. Click")
    web_bot.try_action("7. Click")
    print_step("8. Select the")
    web_bot.try_action("8. Select the")
    print("\n--- DATA ENTRY REQUIRED ---")
