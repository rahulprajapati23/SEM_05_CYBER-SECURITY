"""
Interactive Guide for: Exercise 5 – Creating a system person
"""
import time
import os
import re
...
def main():
    print("=== STARTING EXERCISE: Exercise 5 – Creating a system person ===")
    web_bot = WebBot()
    print("\n--- INSTRUCTIONS ---")
    print_step("1. On the")
    ...
    val = get_input("Linux System-Accounts", "Last Name:")
    val = get_input("Full Name:", "Linux System-Accounts")
    val = get_input("Preferred user ID:", "linuxsystemaccounts")
    val = get_input("First Name:", "Linux")
