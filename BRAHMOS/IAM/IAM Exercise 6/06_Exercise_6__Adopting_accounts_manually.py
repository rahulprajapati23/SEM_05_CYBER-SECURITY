"""
Interactive Guide for: Exercise 6 – Adopting accounts manually
"""
import time
import os
import re
...
def main():
    print("=== STARTING EXERCISE: Exercise 6 – Adopting accounts manually ===")
    web_bot = WebBot()
    print("\n--- INSTRUCTIONS ---")
    ...
    print_step("3. Refresh")
    web_bot.try_action("3. Refresh")
    print_step("4. Refresh")
    web_bot.try_action("4. Refresh")
    print("\n--- DATA ENTRY REQUIRED ---")
    val = get_input("Assign nobody to the", "Linux System-Accounts")
    val = get_input("Close", "Manage Accounts Tab.")
